...
// Query to fetch ordered products and their quantities
$query = "SELECT p.product_name, SUM(c.quantity) AS total_quantity
          FROM cart c
...
<div style="padding: 220px;">
    <canvas id="productChart" width="460" height="260"></canvas>
</div>

<script>
    // JavaScript to plot the chart
