...
// SQL query to fetch cart items which are not ordered
$query = "SELECT cart.cart_id, product.product_name, cart.c_id, cart.quantity
          FROM cart
...
if ($result) {
    // Fetch and display cart items in tabular form
    echo '<table class="styled-table">';
    echo '<thead><tr><th>Cart ID</th><th>Product Name</th><th>Customer ID</th><th>Quantity</th></tr></thead>';
    echo '<tbody>';
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<tr><td colspan="4">No cart items found.</td></tr>';
    }
